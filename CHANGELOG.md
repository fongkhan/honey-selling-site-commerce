...
### Added
- Intégration du module officiel de paiement `@medusajs/payment-stripe` et enregistrement du provider `pp_stripe_stripe` sous le module `@medusajs/payment` dans `medusa-config.ts`.
